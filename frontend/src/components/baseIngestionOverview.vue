<template>
  ...
  <h2 align="center"> Selected Column: {{ columnInfo.columnName }}</h2>
    ...
    <div v-if="'extraInfo' in columnInfo" class="row">
      <div class="col-md-6">
        <div class="card">
      ...
      <div class="col-md-6">
        <div class="card">
          <h5 align="center">Data Patterns</h5>
          <div v-for="(pattern, index) in columnInfo.extraInfo.patterns" :key="index">
            <div class="row">
              <p class="col-md-6">{{ pattern[0]}}</p>
              <p class="col-md-6">{{ pattern[1]}}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row pt-3">
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <h5 align="center"> Data Preview</h5>
              <div class="row">
